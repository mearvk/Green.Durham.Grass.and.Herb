#!/usr/bin/env bash
# Green.Durham.Grass.and.Herb — Local Connectivity & DB Test
...
echo "═══════════════════════════════════════════════════════════════"
echo " Green.Durham.Grass.and.Herb — Local Connectivity & DB Test"
echo " Base URL: ${BASE}"
echo "═══════════════════════════════════════════════════════════════"
...
for jsp in index.jsp ethical.jsp labor.jsp listeners.jsp moral.jsp status.jsp; do
    check "/${jsp}" "${jsp}"
done
...
check_db_page "ethical.jsp"   "<td>|ethical|principle|code"   "ethical.jsp"
check_db_page "labor.jsp"     "<td>|labor|worker|union"       "labor.jsp"
check_db_page "listeners.jsp" "<td>|listener|port|host"       "listeners.jsp"
check_db_page "moral.jsp"     "<td>|moral|value|standard"     "moral.jsp"
